...
namespace Server {
    ...
    public partial class UserDataSet : global::System.Data.DataSet {
        ...
        public partial class tbUsersDataTable : global::System.Data.TypedTableBase<tbUsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public tbUsersRow AddtbUsersRow(string username, string password) {
...
namespace Server.UserDataSetTableAdapters {
    ...
    public partial class tbUsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbUsers] WHERE (([Id] = @Original_Id) AND ((@IsNull_username =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbUsers] ([username], [password]) VALUES (@username, @password" +
                ");\r\nSELECT Id, username, password FROM tbUsers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbUsers] SET [username] = @username, [password] = @password WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT Id, username, password FROM tbUsers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Server.Properties.Settings.Default.DatabaseServerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password FROM dbo.tbUsers";
        ...
        public virtual int Fill(UserDataSet.tbUsersDataTable dataTable) {
        ...
        public virtual UserDataSet.tbUsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet.tbUsersDataTable dataTable = new UserDataSet.tbUsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet.tbUsersDataTable dataTable) {
